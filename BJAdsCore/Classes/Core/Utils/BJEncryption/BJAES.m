                   ...
                   padding:(MIUCryptorPadding)padding;
{
    ...
    return [BJEncryptionHelper stringByEncodingData:data];
}
...
+ (NSString *)MIUAESDecrypt:(NSString *)originalStr
                   ...
                   padding:(MIUCryptorPadding)padding
{
    NSData *data = [BJEncryptionHelper decodeData:[originalStr dataUsingEncoding:NSUTF8StringEncoding]];
    if (!data) {
        return @"";
    }
